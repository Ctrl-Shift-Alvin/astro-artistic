...
export const Translation = ZTranslation.parse({
	...
	contact: {
		...
		feedback: {
			...
			nameError:
				'Error: Please enter a name! Thank you! :)',
			emailError:
				'Error: Please enter a valid email! Thank you! :)',
			phoneNumberError:
				'Error: Please enter a phone number! Thank you! :)',
			sendingError:
	...
	blog: {
		...
		noPosts: 'There are currently no available posts! Check back another time!',
	...
	others: {
		...
		card1: {
			title: 'Movement',
			description:
				'Movement is a less important human bodily function that might be important to some people. Professional humans, however, stride to avoid this at all cost.'
		},
		card2: {
			title: 'Erections',
			description:
				'While around 49.72% of this world\'s human population lack this function (instead offering a more nerfed alternative), it works best when hidden from family members (and generally other people). Some humans might like to occasionally show it to another person, mostly of the opposite sex. However, professional humans are strongly opposed to showing it toanother being.'
		},
		card3: {
			title: 'Thinking',
	...
	events: {
		title: 'Events',
		description: 'Events',
		noEvents: 'There are currently no relevant events, please check back another time!',
		dateRow: 'Date',
	...
	captcha: {
		title: 'Captcha',
		solveField: 'Solution',
		errorFeedback: 'The captcha solution was incorrect! Please enter the correct characters into the solution field!'
	}
});
