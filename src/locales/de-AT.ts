...
export const Translation = ZTranslation.parse({
	...
	card1: {
		title: 'Mein Leben',
		description:
			`Ich wurde am ${formatDateOfBirth(locale)} auf Planet Erde geboren, wie die meisten von uns hier, und seit dem Tag, an dem ich das Licht erblickte, brillierte ich darin, Mensch zu sein. Ich war so gut darin, dass ich sogar meine Eltern (meine Mutter) zum Weinen brachte, als ich meinen ersten Atemzug nahm. Seitdem konzentriere ich mich ausschließlich darauf, meine Performance als Mensch zu verbessern. Heute bin ich einer der menschlichsten Menschen.`,
		buttonText: ''
	},
	card2: {
		title: 'Sonstiges',
		description:
			'Für weniger lebenswichtige menschliche Dienstleistungen besuchen Sie bitte diese Seite, auf der ich professionellen Einblick in u.a. Bewegung, Erektionen und Denken biete.',
	...
	contact: {
		...
		feedback: {
			...
			duplicateError:
				'Ihre Nachricht wurde gesendet, aber verworfen, da es sich um ein Duplikat handelt, das bereits zuvor gesendet wurde.'
		}
	},
	siteInfo: {
		title: 'Seiteninfo',
	...
	blog: {
		...
		noPosts: 'Im Moment sind keine Posts verfügbar! Schauen Sie ein anderes Mal wieder vorbei!',
	...
	others: {
		...
		card1: {
			title: 'Bewegung',
			description:
				'Bewegung ist eine weniger wichtige menschliche Körperfunktion, die für manche Menschen von Bedeutung sein könnte. Professionelle Menschen hingegen vermeiden sie um jeden Preis.'
		},
		card2: {
			title: 'Erektionen',
			description:
				'Während etwa 49,72% der menschlichen Bevölkerung dieser Welt über diese Funktion nicht verfügen (stattdessen bieten sie eine eher abgeschwächte Alternative), funktioniert sie am besten, wenn man sie vor Familienmitgliedern (und generell anderen Menschen) verbirgt. Manche Menschen mögen es, sie gelegentlich einer anderen Person zu zeigen, meist vom anderen Geschlecht. Professionelle Menschen lehnen es jedoch strikt ab, sie einem anderen Wesen zu präsentieren.'
		},
		card3: {
			title: 'Denken',
			description:
				'Professionelle Menschen lehnen dieses menschliche Verhalten strikt ab, da es häufig Depressionen verursacht.'
		},
		card4: {
	...
	events: {
		...
		noEvents: 'Derzeit sind keine relevanten Veranstaltungen vorhanden, bitte schauen Sie zu einem späteren Zeitpunkt noch einmal vorbei!',
		dateRow: 'Datum',
		locationRow: 'Ort',
		titleRow: 'Titel'
	},
